						...
						<tr>
							<td>
								<el-form-item label="出生日期：" prop="dateOfBirth">
									<el-date-picker v-model="form.dateOfBirth" type="date" placeholder="选择日期" format="yyyy 年 MM 月 dd 日" value-format="yyyy-MM-dd">
									</el-date-picker>
								</el-form-item>
							</td>
							<td>
						...
						<tr>
							...
							<td colspan="2">
								<el-form-item label="出生地：" prop="birthplace">
									<el-input type="text" v-model="form.birthplace" auto-complete="off"></el-input>
								</el-form-item>
							</td>
						</tr>
						<tr>
						...
						<tr>
							<td>
								<el-form-item label="住宅电话：" prop="homePhone">
									<el-input type="text" v-model="form.homePhone" auto-complete="off"></el-input>
								</el-form-item>
							</td>
							<td colspan="2">
						...
						<tr>
							<td>
								<el-form-item label="办公电话：" prop="officePhone">
									<el-input type="text" v-model="form.officePhone" auto-complete="off"></el-input>
								</el-form-item>
							</td>
							<td colspan="2">
